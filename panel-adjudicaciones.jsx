...
export default function App() {
  ...
  const [nuevoInvitado, setNuevoInvitado] = useState({ nombre: "", telefono: "", grupo: "", orden: "", plan: "", montoAdjudica: "" });
    ...
    (async () => {
      try {
        const [inv, adj, pl, vu] = await Promise.all([
          window.storage.get("invitados").catch(() => null),
          window.storage.get("adjudicados").catch(() => null),
          window.storage.get("planes").catch(() => null),
          window.storage.get("valoresUnidades").catch(() => null),
        ]);
  ...
  const agregarInvitado = () => {
    ...
    setNuevoInvitado({ nombre: "", telefono: "", grupo: "", orden: "", plan: "", montoAdjudica: "" });
  };
